var SL = SL || (function() {
  ...
  if ($.environment === "WINDOW") {
    ...
    ScriptLoader.prototype.onLoadAllScripts = function() {
      this.exportedCode = this.createExportCode();
    ...
    ScriptLoader.prototype.export = function() {
      downloadWithBlob(new Blob([this.exportedCode]), "export.js");
    };
    ...
    ScriptLoader.prototype.exportLibraryCode = function() {
      var code = "";
      code += 'var SL={';
      code += 'ENVIRONMENT:"' + this. environment + '",';
      code += 'GLOBAL:' + getGlobalObjectName(this.environment) + '';
      code += "};";
      return code;
    };
    /**
    ...
    ScriptLoader.prototype.code = function(arg1, arg2) {
      ...
      // #import(Boolean condition, String path);
      else if (
          typeof arg1 === "boolean" &&
          typeof arg2 === "function" ) {
        code = arg2;
      ...
      // #import(Object params, String path);
        ...
        if (typeof arg1.condition === "function" || typeof arg1.condition === "boolean") {
          condition = arg1.condition;
        }
    ...
    ScriptLoader.Node.prototype.execCodes = function() {
      ...
      for (var i = 0; i < this.codes.length; i++) {
        var code = this.codes[i];
        // コード実行条件が指定されている場合
        if (code.condition !== null && code.condition !== true) {
          var result;
          try {
    ...
    var _downloadElem;
    /**
     * ブラウザ機能によるダウンロードダイアログを表示する.
     * @param {String} url ダウンロードするファイルのURL
     * @param {String} fileName 保存時のファイル名
     */
    var downloadWithURL = function(url, fileName) {
      if(! _downloadElem) {
    ...
    var downloadWithBlob = function(blob, fileName) {
      ...
      downloadWithURL(objURL, fileName);
    }
  }
